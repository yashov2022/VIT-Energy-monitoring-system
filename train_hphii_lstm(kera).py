...
TARGET_POINTS = 3500   # 🔥 slightly increased
WINDOW_SIZE = 288
OUTPUT_SIZE = 1440     # 🔥 full day
...
model.add(Dense(OUTPUT_SIZE))   # 🔥 1440 outputs
...
# SAVE MODEL
# --------------------------------------------------
model.save(os.path.join(MODEL_DIR, "hphii_lstm.keras"))
