...
try:
    ...
    print(f"Yesterday string: {yesterday_str}")
    ...
    logging.info("Selected DB: {db_name}")

    conn.database = db_name

    table = "meitest17"   # 🔁 Change for other buildings
    ...
    conn.commit()
    print("✅ Daily summary stored successfully")
