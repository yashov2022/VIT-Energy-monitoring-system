...
# --------------------------------------------------
query = "SELECT day_date, real_energy FROM energy_16 ORDER BY day_date"
...
joblib.dump(scaler, os.path.join(MODEL_DIR, "scaler_PRP.pkl"))
...
# SAVE MODEL
# --------------------------------------------------
model.save(os.path.join(MODEL_DIR, "prp_lstm.h5"))

print("✅ PRP Model saved successfully")
