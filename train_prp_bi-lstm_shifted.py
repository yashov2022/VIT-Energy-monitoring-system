...
joblib.dump(scaler, os.path.join(MODEL_DIR, "scaler_prp_bi_shifted.pkl"))
...
# SAVE MODEL
# --------------------------------------------------
model.save(os.path.join(MODEL_DIR, "prp_bilstm_shifted.h5"))
