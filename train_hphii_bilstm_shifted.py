...
data_scaled[:, 0] = target_scaler.fit_transform(data[:, 0].reshape(-1, 1)).flatten()
...
predictions_wh = target_scaler.inverse_transform(pred_scaled).flatten()
predictions_wh=predictions_wh*2.4
# --------------------------------------------------
# DAILY ENERGY
# --------------------------------------------------
...
# SAVE MODEL
# --------------------------------------------------
model.save(os.path.join(MODEL_DIR, "hphii_bilstm_shifted.h5"))
